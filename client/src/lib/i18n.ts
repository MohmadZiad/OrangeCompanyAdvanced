...
This calculation shows the prorated billing amount based on the actual days of service used during the {cycleDays}-day billing cycle.`,
    ...
    thinking: "Searching for the best answer...",
    smartSuggestions: "Smart suggestions",
    smartSuggestionsHint: "Follow-up ideas based on your last question",
    retry: "Retry",
    contactSupport: "Contact support",
    deleteConversation: "Delete conversation",
    newConversation: "Start new chat",
    chatErrorMessage: "We ran into a hiccup while reaching the server. Try again or contact support.",
    chatIdleTitle: "Start with a question",
    chatIdleSubtitle: "Here are a few ideas to get the conversation going:",
    chatIdleOption1: "How do I calculate Pro-Rata?",
    chatIdleOption2: "Show me a worked billing example",
    chatIdleOption3: "Explain the monthly invoice flow",
    chatTimestampToday: "Today",
    chatTimestampYesterday: "Yesterday",
    chatTimestampAt: "at",
    clearChatConfirm: "Clear the conversation history?",
...
يوضح هذا الحساب مبلغ الفوترة المقسم بناءً على أيام الخدمة الفعلية المستخدمة خلال دورة الفوترة البالغة {cycleDays} يومًا.`,
    ...
    thinking: "جارٍ البحث عن الإجابة...",
    smartSuggestions: "اقتراحات ذكية",
    smartSuggestionsHint: "متابعة ذكية بناءً على آخر سؤال",
    retry: "إعادة المحاولة",
    contactSupport: "التواصل مع الدعم",
    deleteConversation: "حذف المحادثة",
    newConversation: "بدء محادثة جديدة",
    chatErrorMessage: "حدث خطأ أثناء الاتصال بالخادم. حاول مجددًا أو راجع الدعم.",
    chatIdleTitle: "ابدأ بسؤال",
    chatIdleSubtitle: "إليك بعض الأفكار للانطلاق:",
    chatIdleOption1: "كيف أحسب البروراتا؟",
    chatIdleOption2: "أرني مثال فاتورة عملي",
    chatIdleOption3: "اشرح لي تدفق الفاتورة الشهرية",
    chatTimestampToday: "اليوم",
    chatTimestampYesterday: "أمس",
    chatTimestampAt: "الساعة",
    clearChatConfirm: "هل تريد حذف المحادثة؟",
    supportPrompt: "تحتاج مساعدة؟",
